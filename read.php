...
$spreadsheet = \PhpOffice\PhpSpreadsheet\IOFactory::load('EXCEL_PRUEBA.xlsx');
...
$sheet = $spreadsheet->getSheetByName('Variables de entrada');
...
$calculatedValue = $sheet->getCell('W7')->getValue();
echo "Value of W7: $calculatedValue\n";
